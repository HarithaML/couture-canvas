...
const Category = ({ id, title, imageUrl }) => {
    return (
        ...
        >
            <div className='category-body-container bg-opacity-60 hover:bg-opacity-80 bg-white border-2 border-white w-[200px] h-[100px] flex items-center justify-center flex-col'>
