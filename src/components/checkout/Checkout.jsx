...
const Checkout = () => {
    ...
    return (
        <div className="bg-white w-[1500px] h-[800px] m-10 p-20">
            ...
            {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center mt-[200px] bg-[#BEE7E8] rounded-full  overflow-hidden ">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="grid grid-cols-5 gap-2 mt-4 mb-4 items-center justify-center">
                        <span className="flex col-start-3 col-end-4 items-center justify-center product text-4xl">Total:</span>
                        <span className="flex col-start-4 col-end-5 items-center justify-start product text-4xl">${cartItemTotalPrice}</span>
                        </div>
                </div>
            )}
